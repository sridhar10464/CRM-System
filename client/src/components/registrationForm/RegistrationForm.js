  ...
  return (
    <Container>
      ...
      <ul className='mb-4'>
        ...
        <li className={passwordError.hasLower ? "text-success" : "text-danger"}>Al least one lower case</li>
        <li className={passwordError.hasNumber ? "text-success" : "text-danger"}>Al least one number</li>
        <li className={passwordError.hasSpclChr ? "text-success" : "text-danger"}>Al least one of the special characters i.e @ # $ % &</li>
      </ul>
